...
import { TransactionFactory } from '../src/wallet/transaction/transaction.factory';
import { DepositStrategy } from '../src/wallet/transaction/strategies/deposit.strategy';
import { WithdrawStrategy } from '../src/wallet/transaction/strategies/withdraw.strategy';
import { TransferStrategy } from '../src/wallet/transaction/strategies/transfer.strategy';
...
describe('TransactionService', () => {
  ...
  describe('Deposit Transactions', () => {
    ...
    it('should convert USD to EGP when depositing foreign currency', async () => {
      ...
      const expectedEgpAmount = BigInt(4817000); // $100 * 48.17 rate * 100 cents
